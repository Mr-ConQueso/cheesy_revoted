...
public class PenguinEntityOld extends AnimalEntity implements GeoEntity {

    // --------- / VARIABLES / --------- //
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private static final TrackedData<Boolean> HAS_EGG = DataTracker.registerData(PenguinEntityOld.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<BlockPos> TRAVEL_POS = DataTracker.registerData(PenguinEntityOld.class, TrackedDataHandlerRegistry.BLOCK_POS);
    private static final TrackedData<Boolean> LAND_BOUND = DataTracker.registerData(PenguinEntityOld.class, TrackedDataHandlerRegistry.BOOLEAN);
    private static final TrackedData<Boolean> ACTIVELY_TRAVELING = DataTracker.registerData(PenguinEntityOld.class, TrackedDataHandlerRegistry.BOOLEAN);
    public static final Ingredient BREEDING_ITEM = Ingredient.ofItems(Items.SALMON);

    public PenguinEntityOld(EntityType<? extends PenguinEntityOld> entityType, World world) {
    ...
    @Deprecated
    public static boolean canSpawn(EntityType<PenguinEntityOld> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return pos.getY() < world.getSeaLevel() + 4 && PenguinEggBlock.isGravelBelow(world, pos) && PenguinEntityOld.isLightLevelValidForNaturalSpawn(world, pos);
    }
    ...
    static class PenguinMoveControl extends MoveControl {
        private final PenguinEntityOld penguin;

        PenguinMoveControl(PenguinEntityOld penguin) {
            super(penguin);
    ...
    static class PenguinEscapeDangerGoal extends EscapeDangerGoal {
        PenguinEscapeDangerGoal(PenguinEntityOld penguin, double speed) {
            super(penguin, speed);
        }
    ...
    static class MateGoal
        ...
        MateGoal(PenguinEntityOld penguin, double speed) {
            super(penguin, speed);
            this.penguin = penguin;
        }
    ...
    static class LayEggGoal
        ...
        LayEggGoal(PenguinEntityOld penguin, double speed) {
    ...
    static class WanderInWaterGoal extends MoveToTargetPosGoal {
        ...
        WanderInWaterGoal(PenguinEntityOld penguin, double speed) {
    ...
    static class GoHomeGoal extends Goal {
        ...
        GoHomeGoal(PenguinEntityOld penguin) {
            this.penguin = penguin;
        }
        ...
        public static class TravelGoal extends Goal {
            ...
            TravelGoal(PenguinEntityOld penguin, double speed) {
                this.penguin = penguin;
                this.speed = speed;
            }
        ...
        public static class WanderOnLandGoal extends WanderAroundGoal {
            ...
            WanderOnLandGoal(PenguinEntityOld penguin, double speed, int chance) {
        ...
        public static class PenguinSwimNavigation extends AmphibiousSwimNavigation {
            PenguinSwimNavigation(PenguinEntityOld owner, World world) {
                super(owner, world);
            }
            ...
            public boolean isValidPosition(BlockPos pos) {
                ...
                if (mobEntity instanceof PenguinEntityOld && ((PenguinEntityOld) mobEntity).isActivelyTraveling()) {
